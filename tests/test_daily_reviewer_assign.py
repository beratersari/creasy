...
from test_azure_webhook import _app as _azure_app
from test_azure_webhook import _auth, _pr_with_bot
from test_webhook import _app as _gitlab_app
...
def test_gitlab_unassign_bot_does_not_start_a_job(tmp_config):
    app, manager, runner = _gitlab_app(tmp_config)
    client = TestClient(app)
    payload = {
        "object_kind": "merge_request",
