"""Product version and brand. ``VERSION`` at the repo root is the source of truth."""
...
def version_path() -> Path | None:
    from mireviewer.paths import bundled_file, executable_dir, is_frozen
