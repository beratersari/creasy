"""OSM job-end kill/delete order (PLAN §8).

The steps are identical to opencode_manager.cleanup.end. Creasy starts this
cascade on MR close/merge, not when a review job finishes.
"""
...
from mireviewer.cleanup.rmtree import hard_delete
from mireviewer.jobs.models import JobRecord
from mireviewer.logging import get_logger

logger = get_logger("cleanup.end")
